...
const translations = {
  ...
  login_failed_generic: '登录失败啦～可能是应用版本太旧，麻烦更新到最新版 APP；如果更新后还是不行，联系管理员协助处理哦～',
  ...
  login_failed_generic: 'Login failed — the app may be out of date. Please update to the latest version. If the problem persists, contact the administrator.',
  ...
  login_failed_generic: '로그인에 실패했습니다. 앱 버전이 오래된 것일 수 있으니 최신 버전으로 업데이트해 주세요. 계속 문제가 발생하면 관리자에게 문의하세요.',
  ...
  login_failed_generic: 'ログインに失敗しました。アプリのバージョンが古い可能性があります。最新のアプリに更新してください。解決しない場合は管理者に連絡してください。',
